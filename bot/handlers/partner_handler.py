...
async def partner_function(msg: types.Message):
    ...
    if tg_user['language'] == 'uz':
        await msg.answer(text="""   Bu yerda siz sotuvchi yoki sotib oluvchi sifatida hamkorlikni yo'lga qo'yishingiz mumkin.
...
""", reply_markup=await partner_buttons())
        ...
        await msg.answer(text="""   Здесь вы можете наладить сотрудничество в качестве продавца или покупателя.
